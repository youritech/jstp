...
//
const newConnectFn = (connect, transportName) =>
...
//
const newConnectAndInspectFn = (connect, transportName) =>
...
//
const newReconnectFn = connect =>
  transportCommon.newReconnectFn(socketFactory(connect), Transport);
