...
function Connection(transport, server, client) {
  ...
  this._handlers = {
    handshake: this._processHandshakePacket.bind(this),
    call: this._processCallPacket.bind(this),
    callback: this._processCallbackPacket.bind(this),
    event: this._processEventPacket.bind(this),
    inspect: this._processInspectPacket.bind(this),
    state: this._processStatePacket.bind(this)
  };
}
