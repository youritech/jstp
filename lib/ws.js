...
class Server extends http.Server {
  ...
  constructor(options, webSocketOptions = {}, listener) {
    ...
    jstpServer.initServer.call(
      ...
      options.sessionStorageProvider, options.heartbeatInterval,
      options.clientExpirationTime, listener
    );
