...
const filterKeys = (arr, forbidden) => (
...
const split = (str, separator, limit, leaveEmpty) => {
  const result = [];
  let start = 0;
...
const iterativeCompletion = (inputs, depth, completer) => {
  let help = '';
  let completions = [];
  let newDepth = depth;
