...
//   source - tested string
//   substring - substring to test with
//
common.startsWith = function(source, substring) {
  var actualSubstring = source.substr(0, substring.length);
  return actualSubstring === substring;
};
