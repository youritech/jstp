...
//
const connect = sock.newConnectFn(tls.connect, 'tls');

// see transportCommon.newConnectAndInspectFn
//
const connectAndInspect = sock.newConnectAndInspectFn(tls.connect, 'tls');

// see transportCommon.newReconnectFn
//
const reconnect = sock.newReconnectFn(tls.connect);
