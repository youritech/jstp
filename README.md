...
Однако, не все парсеры смогут поддерживать функции и выражения, да это и
не нужно. Поэтому, мы разделим JSRS на два уровня Level 1 и Level 2,
которые будем соответственно обозначать JSRS/1 (поддерживающий только
значения) и JSRS/2 (поддерживающий выражения и функции).
